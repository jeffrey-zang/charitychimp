...
export const AppContextProvider: React.FC<{children: React.ReactNode|React.ReactNode[]}> = ({children}) => {
    const [charities, setCharities] = React.useState<Charity[]>([
        ...
        {name: "Funky Ferret Fund", tagline: "Help ferrets living in Southern California pay rent", goal: 2000, current: 600, verified: false, tags: ["animals", "housing"], poster: ['https://cdn.discordapp.com/attachments/1042229990739169341/1046427941443211274/image.png', "fredthefileferret"]},
    ])
